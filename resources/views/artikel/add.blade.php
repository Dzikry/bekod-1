					...
					<div class="section-body">
						<div class="row">
							...
							<div class="col-sm-8 col-md-9 col-lg-10">
								<h3>Buat Artikel</h3>
								<form class="form" id="formCompose" role="form" action="{{ url('artikel/save') }}" method="POST" enctype="multipart/form-data">
									<div class="form-group floating-label">
										<input type="text" class="form-control" id="to1" name="author" >
										<label for="to1">Author</label>
										
									</div><!--end #emailOptions -->
									<div class="form-group floating-label">
										<input type="text" class="form-control" id="Subject1" name="judul" >
                      ...
                      <input type="file" name="gambar" id="exampleInputFile" class="btn ink-reaction btn-raised btn-primary">
                    </div>
								</form>
							</div><!--end .col -->
							<!-- END MAIL COMPOSE -->
